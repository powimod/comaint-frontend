...
const StockCategoryBloc = () => {
	...
	return <DashboardBloc 
		className="bloc-article-category" 
		label="dashboard.bloc.category"
		icon="category" 
		value={blocValue} 
		onClick={onBlocClick} /> 
}

export default StockCategoryBloc
